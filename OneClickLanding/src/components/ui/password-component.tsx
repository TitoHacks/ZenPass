...
function PasswordComponent(props:any){
  ...
  return (
    <div className=' my-2 ml-9 bg-backgroundColorDark p-4 rounded-xl w-4/6 flex flex-row justify-between items-center hover: cursor-pointer' onClick={function(){props.setPasswordItem(props.passwordItem); props.setDetail(true)}}>
        ...
        <Chip className="capitalize self-start" color={statusColorMap[status]} size="sm" variant="flat">{status}</Chip>
